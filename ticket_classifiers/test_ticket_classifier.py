...
def main():
    ...
    classify_all_images(model, test_logos=True) #classify all images in the dataset

    predict_image(model, "images/megamillions/IMG_0706.jpeg") #path to a test image
