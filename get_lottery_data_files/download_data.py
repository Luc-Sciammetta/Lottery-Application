...
# I did not make this myself, I got this from here: https://gist.github.com/bramp/6ae5a9977f805e18cbee0b0b362d9fef
...
def download_results():
    ...
    fieldnames = {
        ...
        # Winning Numbers
        'ball1': 'WinningNumbers."0".Number',
        'ball2': 'WinningNumbers."1".Number',
        'ball3': 'WinningNumbers."2".Number',
        'ball4': 'WinningNumbers."3".Number',
        'ball5': 'WinningNumbers."4".Number',
        ...
        '0 + Powerball Count': 'Prizes."9".Count',
        '0 + Powerball Amount': 'Prizes."9".Amount',
    }
